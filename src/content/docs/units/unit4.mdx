...
- Explorar cómo se pueden aplicar estos conceptos en la creación de simulaciones interactivas.
- Aprender a utilizar herramientas y técnicas para implementar el movimiento angular en tus proyectos.
...
- Si omites, cualquiera, el enlace a tu obra, el código, la captura de pantalla, la descripción de la 
interacción o la explicación conceptual tendrás una penalización de 1 unidad en la nota final.
- Si no sigues el formato propuesto en la bitácora tendrás una penalización de 1 unidad en la nota final.
- Si no presentas tu obra en la última sesión de la unidad tendrás una penalización de 1 unidad en la nota final.
